...
const tmpSurveys = [
    {
        "id": 1,
        "image_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSI196j6XjFbTkatjULgXGvcEdOkqs6yf2HbNdmkwe6mQ&s",
        "title": "Toto Gaspy YouTube channel",
        "slug": "totogaspytv-youtube-channel",
        "status": true,
        "description": "My name is Vince.<br>I am Web Developer with less than a year of experience and father of one astonishing kid.<br><br>The purpose of the channel is to share my daily activities as a developer and as a father.<br>Teach them what I know and make my experience as a lesson for others.",
        "created_at": "2023-10-07 13:23:41",
        "updated_at": "2023-10-12 16:34:19",
        "expire_date": "2023-10-31",
        "questions": [
          {
            "id": 15,
            "type": "text",
          ...
          },
          {
            "id": 16,
            "type": "checkbox",
            "question": "Which  video do you like the most on my channel?",
          ...
          },
          {
            "id": 22,
            "type": "textarea",
            "question": "What do you think about totogaspytv channel?",
      ...
      },
      {
        ...
        "slug": "react",
        "status": true,
        "description": "React with Vite is a web development stack combining React for UI development and Vite as a fast build tool, offering efficient, rapid development for modern web applications.",
      ...
      },
      {
        ...
        "slug": "Nodejs",
        "status": true,
        "description": "Node.js is an open-source, server-side JavaScript runtime environment that enables asynchronous, event-driven programming for building scalable network applications.",
